...
class TaskServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.createTask = channel.unary_unary(
                ...
                response_deserializer=task__pb2.Transaction.FromString,
                )
        self.getTasks = channel.unary_stream(
                '/taskPackage.TaskService/getTasks',
                request_serializer=task__pb2.NoParameters.SerializeToString,
        ...
        self.streamCreateTask = channel.stream_unary(
                ...
                request_serializer=task__pb2.Task.SerializeToString,
                response_deserializer=task__pb2.Transactions.FromString,
                )
...
def add_TaskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'createTask': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=task__pb2.Transaction.SerializeToString,
            ),
            'getTasks': grpc.unary_stream_rpc_method_handler(
                    servicer.getTasks,
                    request_deserializer=task__pb2.NoParameters.FromString,
            ...
            'streamCreateTask': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=task__pb2.Task.FromString,
                    response_serializer=task__pb2.Transactions.SerializeToString,
            ),
...
class TaskService(object):
    ...
    def createTask(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/taskPackage.TaskService/createTask',
            ...
            task__pb2.Transaction.FromString,
    ...
    def getTasks(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/taskPackage.TaskService/getTasks',
            task__pb2.NoParameters.SerializeToString,
    ...
    def streamCreateTask(request_iterator,
        ...
        return grpc.experimental.stream_unary(request_iterator, target, '/taskPackage.TaskService/streamCreateTask',
            task__pb2.Task.SerializeToString,
            task__pb2.Transactions.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
